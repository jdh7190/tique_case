! function(t, e) {
    ...
    return function(t) {
        ...
        const R = (t, e) => t.some((t => x(t, e)));

        function I(t, e = "limit") {
        ...
        t.exports = {
            ...
            Pt: R,
            Ot: function(t, e) {
                return t.concat(e.filter((e => !R(t, e))))
            },
            vt: function(t, e) {
                return t.filter((t => !R(e, t)))
            },
            $t: I,
            St: class {
                ...
                Rt() {
                    if (new Date - this.xt > I(this.At, "timeout")) throw new TimeoutError(`${this.It} timeout`)
                }
            },
            Ct: T,
            jt: function(t) {
                return Object.keys(t).sort(C)
            },
            Tt: C
        }
    }, function(t, e, n) {
        ...
        (function(e) {
            const {
                ...
                ye: R,
                ge: I
            } = O, T = n(21), C = n(8), j = n(22), {
                ArgumentError,
                StateError
            } = n(4), k = C.P, N = "Editor", U = new WeakMap, M = {}, F = new Map, D = {};
            class L {
                be(t, e) {
                ...
                ne(t, n = !1) {
                    ...
                    e.env.COVER && Object.keys(o).forEach((t => {
                        delete o[t]
                    })), c(a) && l(o, "sealed", a), c(u) && l(o, "upgradable", u), c(h) && l(o, "interactive", h), Q(o, this.me), m.Ne(this.Vt, o), o.origin = `native://${t.name}`, o.location = `native://${t.name}`, o.nonce = 0, o.owner = null, o.satoshis = 0, D[t.name] = this.me, j.Le(this.me).Be = T.Je(), this._e = t, this.Ee = t.name, this.Jt = w(this.Vt.toString(), this.Ee), this.Pe = !1, this.Oe = !0, this.ve = !0, this.Wt = !0, this.Ae = n
                }
                We() {
                ...
                function(t) {
                    ...
                    for (const t of Object.keys(e)) {
                        ...
                        if (r) {
                            ...
                            x(n.nonce), R(n.owner, !0), I(n.satoshis)
                        }
            ...
            L.ee = G, L.Xe = V, L.Kt = function(t, e, o = !0, i) {
                ...
                function e(e, n) {
                    f(n, "presets") && f(n.presets, t) ? $.forEach((e => l(n, e, n.presets[t][e]))) : C.Z.includes(n.name) || O.Ge(n)
                }
        ...
        t.exports = {
            A: function(t) {
                if ("string" != typeof t) throw new Error(`Location is not a string: ${o(t)}`);
                const e = t.match(d) || t.match(w) || t.match(p) || t.match(f) || t.match(l);
                if (e) {
                    const n = {},
                        r = e.groups;
                    return "record" === r.protocol && (n.Hr = r.record), "error" === r.protocol && (n.ae = r.error), "native" === r.protocol && (n.Wt = r.native), s(r.txid) && (n.pu = r.txid), s(r.vout) && (n.fu = parseInt(r.vout)), s(r.vdel) && (n.lu = parseInt(r.vdel)), s(r.berry) && (n.du = decodeURIComponent(r.berry)), s(r.hash) && (n._hash = r.hash), s(r.version) && (n.mr = u(parseInt(r.version))), t === _ && (n.wu = !0), n
                }
                throw new Error(`Bad location: ${o(t)}`)
            },
            Rn: function(t) {
                if (c("object" == typeof t && t), s(t.ae)) return `error://${t.ae}`;
                if (s(t.Wt)) return `native://${t.Wt}`;
                let e = "";
                s(t.Hr) && (e = `record://${t.Hr}`), s(t.pu) && (e = t.pu);
                let n = "";
                s(t.fu) && (n = `_o${t.fu}`), s(t.lu) && (n = `_d${t.lu}`);
                const r = [];
                return s(t.du) && (r.push(`berry=${encodeURIComponent(t.du)}`), s(t._hash) && r.push(`hash=${t._hash}`), s(t.mr) && r.push(`version=${t.mr}`)), `${e}${n}${r.length?`?${r.join("&")}`:""}`
            },
            we: function(t) {
            ...
            ye: function(t, e = !1, i) {
                ...
                if ("string" == typeof t) {
                    ...
                    try {
                        const e = new CommonLock(t, i ? "testnet" === i : void 0);
                        return e.script(), e
                    } catch (t) {}
                }
                const {
            ...
            ge: function(t) {
                ...
                if (t > h) throw new Error("satoshis must be <= 100000000");
                return t
            },
            Ge: function(t) {
                a((() => {
                    i(t, "location", _), i(t, "origin", _), i(t, "nonce", 0), i(t, "owner", undefined), i(t, "satoshis", undefined)
                }))
            },
            Er: y,
            Pr: b,
        ...
        class x {
            ...
            async Fr(t, e) {
                this.At.Rt(), e ? i.ue && i.ie(v, "Load", t, "with", a(e)) : i.ue && i.ie(v, "Load", t);
                const n = new Date;
                try {
                    ...
                    i.zt && i.Yt(v, "Load (end): " + (new Date - n) + "ms")
                }
            }
            async Br(t) {
                this.At.Rt();
                const {
                    Gr: e
                } = n(23), r = l(t), o = r.pu + (f(r.fu) ? `_o${r.fu}` : `'_d${r.lu}`), i = r.du, s = r._hash, c = r.mr || b, a = `berry://${p({pu:r.pu,lu:r.lu,fu:r.fu,du:i,mr:c})}`, u = await e(a, s, this);
                if (u) return this.Ur.push(u.Vr), u.Jr;
                const h = new x(this.B, this.At),
                    d = await h.$n(o);
            ...
            async Lr(t) {
                ...
                const {
                    ...
                    fu: r,
                    lu: i
                } = l(t), s = await this.B.Se().fetch(e), c = new o(s), a = R(c), u = "number" == typeof r && r >= 1 && r <= a.out.length, h = "number" == typeof i && i >= 0 && i < a.del.length;
            ...
            async zr(t, e, r) {
                ...
                if (this.Nr.has(o)) c = await this.Nr.get(o);
                    ...
                    if (P.has(o)) return await P.get(o), await this.Lr(r);
                    try {
                        const r = n(28),
                            i = !0,
                            s = null,
                        ...
                        this.Nr.set(o, u), P.set(o, u), c = await u
                    } finally {
                        this.Nr.delete(o), P.delete(o)
                    }
                }
                const a = c.Hr;
            ...
            async Wr(t, e, o, B) {
                this.At.Rt(), s(B instanceof Code), i.ue && i.ie(v, "Pluck", a(B), t);
                const c = {
                        b: this.B.Se(),
                        se: t => {
                            A = A || t
                ...
                try {
                    ...
                    const c = B.pluck(t, u);
                    if (!(c instanceof m.Promise || c instanceof E.Promise)) throw new StateError("pluck method must be async");
                    const y = await c;
                    if (!y || y.constructor !== B) throw new StateError(`Berry must be an instance of ${a(B)}`);
                    if (i) {
                        const {
                            Kr: t
                        } = n(23), i = t(y, o), c = h(i), a = new r.deps.Buffer(c, "utf8"), u = (await g(a)).toString("hex");
            ...
            Mr(t) {
                ...
                if (_.Gt(n).Ae) throw new ArgumentError(`${a(n)} cannot be a dependency`);
                return n
            }
        }
        ...
        function R(t) {
            const {
                Zr: e
            } = n(16), r = "Not a run transaction: invalid op_return protocol", o = "Not a run transaction: invalid run payload";
        ...
        x.Qr = R, x.$r = function(B) {
            if (O !== B) throw new Error("Must only create berry from its berry class");
            const t = S;
            return O = null, S = null, t
        }, t.exports = x
    }, function(t, e, n) {
        (function(e) {
            const r = n(9),
            ...
            async function p(t, n, r, o, i) {
                ...
                let a = e.alloc(32),
                    l = e.alloc(32),
                    p = e.alloc(32);
                n & u.SIGHASH_ANYONECANPAY || (a = await async function() {
                    ...
                    const n = e.toBuffer();
                    return t._hashPrevouts = await w(n), t._hashPrevouts
                }()), n & u.SIGHASH_ANYONECANPAY || (31 & n) === u.SIGHASH_SINGLE || (31 & n) === u.SIGHASH_NONE || (l = await async function() {
                    ...
                    const n = e.toBuffer();
                    return t._hashSequence = await w(n), t._hashSequence
                }()), (31 & n) !== u.SIGHASH_SINGLE && (31 & n) !== u.SIGHASH_NONE ? p = await c() : (31 & n) === u.SIGHASH_SINGLE && r < t.outputs.length && (p = await c(r));
                const d = new f;
                d.writeInt32LE(t.version), d.write(a), d.write(l), d.writeReverse(s.prevTxId), d.writeUInt32LE(s.outputIndex), d.writeVarintNum(o.toBuffer().length), d.write(o.toBuffer()), d.writeUInt64LEBN(i), d.writeUInt32LE(s.sequenceNumber), d.write(p), d.writeUInt32LE(t.nLockTime), d.writeUInt32LE(n >>> 0);
                const y = d.toBuffer(),
                    b = await w(y);
                return new h(b).readReverse()
            }
            async function d(t) {
                const e = n(43).sha256,
                    o = await e(t);
                return r.deps.Buffer.from(o)
            }
            async function w(t) {
                const e = await d(t);
                return await d(e)
            ...
            t.exports = {
                ...
                Os: async function(t) {
                    return t._hash = t._hash || (await d(t.toBuffer())).reverse().toString("hex"), t._hash
                },
                vs: p,
                $s: async function(t, n, r, o, i, s = u.SIGHASH_ALL) {
                    s |= u.SIGHASH_FORKID;
                    const c = new l(o),
                        h = await p(t, s, n, r, c),
                        f = a.sign(h, i, "little"),
        ...
        async function I(t) {
            try {
                ...
                const b = await R.Fi((async () => {
                    const e = await J(y, t, w);
                    i.Rt();
        ...
        async function U(t, e) {
            ...
            const {
                zi: r
            } = n(23), o = new Map, i = t.Hr, s = i.Bn.concat(i.Un);
            for (const n of s) {
        ...
        async function M(t, e) {
            ...
            for (const [t, n] of e) {
                if (o.has(t)) continue;
                const e = await r(n).then((e => o.set(t, e)));
                i.push(e)
            }
            return await Promise.all(i), t.th = o, o
        }
        ...
        async function z(t, e, n, o) {
            const i = t.inputs,
                s = (await Promise.all(i.map((t => h().Se().fetch(t.prevTxId.toString("hex")))))).map((t => new r.Transaction(t))),
                c = i.map(((t, e) => s[e].outputs[t.outputIndex])),
                a = c.map((t => t.script.toHex())),
                u = c.map((t => t.satoshis));
            return a.map(((t, e) => ({
                script: t,
                satoshis: u[e]
            })))
        ...
        I.es = T, I.ns = C, I.rs = j, I.os = k, I.ss = N, I.cs = U, I.us = M, I.hs = F, I.fs = D, I.ls = L, I.Zi = G, I.ps = R, I.ds = J, I.ws = Y, I.ys = K, I.gs = H, I.bs = V, I._s = q, t.exports = I
    }, function(t, e, n) {
        const {
            ro: r
        } = n(19), {
        ...
        t.exports = {
            ...
            Ir: function(t, e, o) {
                const Berry = n(12),
                    i = n(10).Zt;
                if (w.ue && w.ie(b, "Pluck", c(t)), i.Jn = !1, i.en((() => {
                        let n = t;
                    ...
                    })), i.Tn.length) throw new Error("Not actions allowed during pluck");
                i.rn()
            }
        }
    }, function(t, e, n) {
        ...
        class V {
                    ...
                    return F().en((() => {
                        ...
                        try {
                            ...
                            const f = () => {
                                    ...
                                    if (u instanceof C.Promise || u instanceof j.Promise) throw new StateError("async methods not supported");
                                    z(u), u = a.jo(u, l), l && a.To()
                                },
                                p = !a.Be.ko || !a.Be.ko.includes(t.name);
                            if (n(18).po(e, t.name, r, f, p), l) {
                                const Creation = n(6);
                                o((() => R(k.wo(e), (t => {
            ...
            Uo(t, e, n) {
                return this.mo() ? Reflect.defineProperty(t, e, n) : this.Eo((() => (this.Po(), this.Fo(e, n.value, "define"), W(n), this.Do() && F().ur(this.oo), n.value = this.Mo(n.value), this.Bo(e) && (G.nr = !0), Reflect.defineProperty(t, e, n))))
            }
            Lo(t, e) {
            ...
            Gt(t, e, r) {
                return this.mo() ? Reflect.get(t, e, r) : this.Eo((() => {
                    this.Po();
                    const i = e === Symbol.hasInstance && t[Symbol.hasInstance] !== C.Function.prototype[Symbol.hasInstance] && t[Symbol.hasInstance] !== j.Function.prototype[Symbol.hasInstance];
            ...
            Mo(t) {
                ...
                const e = k.Le(t),
                    r = k.wo(t) || t;
                return e ? e.Be.oo === this.oo ? r : x(e.yo, C) : (D().length && G.Ro && G.Ro.add(r), r)
            }
            Co(t) {
                let e = this.oo,
                    r = this.yo;
                ...
                i(G), I(G.Ro, ((t, e) => {
                    ...
                    ! function(t) {
                        o((() => {
                            ...
                            const e = [];
                            (t instanceof C.Array || t instanceof j.Array) && e.push("length");
                            const n = t instanceof C.Uint8Array || t instanceof j.Uint8Array;
                            Object.getOwnPropertyNames(t).filter((t => !e.includes(t))).map((e => Object.getOwnPropertyDescriptor(t, e))).forEach((t => W(t, !n)))
                        }))
                    }(t);
                    const r = k.Le(t);
                    if (!r) return void e(!0);
                    const i = k.wo(t);
                    return e(!1), r.Be.oo === this.oo ? i : x(r.yo, C)
            ...
            vi(t) {
                ...
                let n = !1;
                return R(G.Ro, (e => !n && (!k.wo(e) && (e === t ? (n = !0, !1) : void 0)))), n && G.Ro.add(t), n
            }
            mo() {
                return this.Be.Sn && r()
            }
        ...
        t.exports = {
            zi: async function(t, e, n) {
                ...
                const l = Object.assign({}, i.er),
                    ...
                    w = -1 === p ? `_d${d}` : `_o${p+1}`;
                return l.location = w, s(!l.origin.startsWith("record://") || l.origin.startsWith(`record://${r.Cn}`)), l.origin.startsWith(`record://${r.Cn}`) && (l.origin = w), f.props = h.Ki(l), i.Jt && (f.src = i.Jt), f.version = O(e.mr), f
            },
            Kr: function(t, e) {
                const n = (new v).Hi((t => {
                ...
                return r.props = n.Ki(o), r.version = O(e), r
            },
            Gr: async function(t, e, s) {
                ...
                if (!u) return;
                o.ue && o.ie($, "Recreate", t), S(u.version);
                let l = null;
                if ("berry" === u.kind || e && !s.B.yu.has("cache")) {
                    const n = f(u),
                        o = new r.deps.Buffer(n, "utf8");
                    if (l = (await g(o)).toString("hex"), e && l !== e) throw new StateError(`State hash mismatch for ${t}`)
                }
                const O = new Map,
                    x = (new v).Ws().Js((t => (O.set(t, null), (t => {
                        class e {}
                        return e.location = t, e
                    })(t)))),
                    R = x.zs(u.props);
                switch (u.cls && x.zs(u.cls), u.kind) {
                    case "code": {
                        ...
                        return async function(t, e, n, r, o) {
                            ...
                            const m = (async () => {
                                ...
                                const i = (new v).Ws().Js(e).zs(t.props);
                                b((() => {
                    ...
                    case "jig": {
                        ...
                        return async function(t, e, n, r, o) {
                            ...
                            async function a() {
                                ...
                                const s = (new v).Ws().Js(i).zs(t.props);
                                b((() => {
        ...
        class p {
            constructor() {
                this.Hr = new o, this.Hr.Wn = !1, this.Hr.Jn = !1, this.Kn = null, this.hc = null, this.pu = null, this.fc = null, this.lc = null, this.dc = null, this.wc = null, this.yc = null, this.eh = null, this._r = !1
            }
            get outputs() {
                return [...this.Hr.Bn]
            }
            ...
            update(t) {
                ...
                if (this.eh) throw new Error("update disabled during cache");
                if (this._r) throw new Error("update disabled once published");
                this.Kn = null, this.hc = null, this.pu = null;
                const e = o.Zt;
                try {
            ...
            pay() {
                ...
                if (this.eh) throw new Error("pay disabled during cache");
                const t = new h("pay"),
                    e = async () => {
                        const {
                            ps: e,
                        ...
                        await e.Fi((async () => {
                            ...
                            this.hc = await o(this.hc, this.Kn, e), this.pu = null, t.Rt()
                        }))
                    };
            ...
            sign() {
                ...
                if (this.eh) throw new Error("sign disabled during cache");
                const t = new h("sign"),
                    e = async () => {
                        const {
                            ps: e,
            ...
            cache() {
                s.ue && s.ie(l, "Cache");
                const t = new Date;
                if (p.Ht) throw new StateError("cache disabled during atomic update");
                if (this.lc) throw new Error("cache disabled during pay");
                if (this.dc) throw new Error("cache disabled during sign");
                if (this.wc) throw new Error("cache disabled during export");
                if (this.yc) throw new Error("cache disabled during publish");
                if (this.fc) throw new Error("cache disabled during build");
                if (this.eh) return this.eh;
                const e = new h("cache"),
                    r = async () => {
                        const {
                            _s: t
                        } = n(17);
                        await t(this.Kn, this.Kn.Ic, this.pu || this.hc.hash), e.Rt()
                    };
                this.eh = this.gc(e, !1).then((() => r()));
                return this.eh.then((() => {
                    s.zt && s.Yt(l, "Cache (end): " + (new Date - t) + "ms"), this.eh = null
                })).catch((t => {
                    throw this.eh = null, t
                })), this.eh
            }
            publish(t = {}) {
                s.ue && s.ie(l, "Publish");
                ...
                if (this.eh) throw new Error("publish disabled during cache");
            ...
            export (t = {}) {
                ...
                if (this.eh) throw new Error("export disabled during cache");
            ...
            rollback() {
                ...
                if (this.eh) throw new Error("rollback disabled during cache");
            ...
            static async mc(t, e) {
                ...
                const n = f(t),
                    ...
                    c = new p;
                return c.Hr = o.Hr, c.Kn = o, c.hc = t, c.pu = e, c
            }
            gc(t, e) {
            ...
            async Ec(t, e) {
                try {
                    ...
                    await y(t.B, o, _, E, v, e), e.Rt(), this.Kn = t, this.hc = v, this.pu = null
                } catch (e) {
                    throw t.Ni() && t.Bi(e), e
                }
            }
        ...
        async function $(t, e, $, A, x, R, I, T) {
            const C = n(64);
            c.ue && c.ie(S, "Replay", e);
            const j = new Date;
            (I = I || new s("replay", A.At)).Rt();
            ...
            if (k = await Promise.all(k), N = await Promise.all(N), R && !k.some((t => t.location === R.location))) throw new StateError(`${r(R)} not found in the transaction\n\ntxid: ${e}\njig: ${R.location}`);
            const {
                vc: M,
                $c: F
            } = h(k, N, R);
            R && (k[k.findIndex((t => t.location === R.location))] = R);
            const D = new u;
            D.Wn = !0, D.Jn = !1;
            const L = u.Zt;
            l(!1);
            ...
            try {
                ...
                c.zt && c.Yt(S, "Replay (end): " + (new Date - j) + "ms")
            }
        }
        $.Qi = class {
            constructor(t, e) {
        ...
        class G {
            constructor(t = {}) {
                E.ue && E.ie(L, "Create"), t = Object.assign({}, G.defaults, t), this.logger = t.logger, this.networkRetries = t.networkRetries, this.networkTimeout = t.networkTimeout, this.B = new c, this.B.Xc = H(t.cache), this.B.Yr = rt(t.client), this.B.Qc = z(t.blockchain, t.api, t.apiKey, t.network, this.B.qr()), this.B.ta = Y(t.purse, this.B.Se(), t.wallet), this.B.qi = K(t.app), this.B.ye = Q(t.owner, this.B.Se(), t.wallet), this.B.At = X(t.timeout), this.B.yu = function(t) {
                    const e = c._ && c._.yu;
                    if (void 0 === t) return e || [];
                    "string" == typeof t && (t = [t]);
                    if (!Array.isArray(t) || t.some((t => !it(t)))) throw new Error(`Not trustable: ${v(t)}`);
                ...
                }(t.trust), this.B.Zi = tt(t.preverify), this.B.dr = et(t.rollbacks), this.Oa = nt(t.autofund), this.va = ot(t.inventory), W(this), this.activate()
            }
            get app() {
                return this.B.qi
            }
            ...
            set api(t) {
                this.B.Qc = z(void 0, t, this.blockchain.apiKey, this.blockchain.network, this.B.qr())
            }
            set apiKey(t) {
                this.B.Qc = z(void 0, this.blockchain.api, t, this.blockchain.network, this.B.qr())
            }
            set autofund(t) {
                this.Oa = nt(t)
            }
            set blockchain(t) {
                this.B.Qc = z(t), this.B.ta instanceof T && (this.B.ta.blockchain = this.B.Qc), W(this)
            }
            set cache(t) {
            ...
            set inventory(t) {
                this.va && this.va.deactivate(), this.va = ot(t), this.va && this.va.activate(this)
            }
            set logger(t) {
                this.re = function(t) {
                    if (t instanceof u) return t;
                    if (void 0 === t) return E.oe;
                    if (null === t) return {};
                    throw new Error(`Invalid logger: ${v(t)}`)
                }(t), V(this) && (E.re = this.re)
            }
            set network(t) {
                this.B.Qc = z(void 0, this.blockchain.api, this.blockchain.apiKey, t, this.B.qr())
            }
            set networkRetries(t) {
                this.$a = S.Ys = q(t), V(this) && (S.Ys = q(t))
            }
            set networkTimeout(t) {
                this.Sa = Z(t), V(this) && (S.At = Z(t))
            }
            set owner(t) {
                this.B.ye = Q(t, this.B.Se()), this.va && this.va.deactivate(), this.va = new x, this.va.activate(this)
            }
            set rollbacks(t) {
                this.B.dr = et(t)
            }
            ...
            load(t, e = {}) {
                if (J(this), g.Ht) throw new StateError("load disabled during atomic update");
            ...
            trust(t) {
                if (E.ue && E.ie(L, "Trust", t), !it(t)) throw new ArgumentError(`Not trustable: ${v(t)}`);
                this.B.yu.add(t)
            }
            on(t, e) {
                if (!c.oa.includes(t)) throw new ArgumentError(`Invalid event: ${t}`);
                if ("function" != typeof e) throw new ArgumentError(`Invalid listener: ${v(O)}`);
            ...
            off(t, e) {
                if (!c.oa.includes(t)) throw new ArgumentError(`Invalid event: ${t}`);
                if ("function" != typeof e) throw new ArgumentError(`Invalid listener: ${v(e)}`);
                this.B.ea = this.B.ea.filter((n => !(n => n.na === t && n.ra === e)(n)))
            }
            activate() {
                if (E.ue && E.ie(L, "Activate"), g.Ht) throw new StateError("activate disabled during atomic update");
                return G.instance = this, this.va && this.va.activate(this), this.B.an(), this.logger = this.re, this.networkRetries = this.$a, this.networkTimeout = this.Sa, this
            }
            deactivate() {
                if (E.ue && E.ie(L, "Deactivate"), g.Ht) throw new StateError("deactivate disabled during atomic update");
                return G.instance = null, this.va && this.va.deactivate(), this.B.cn(), this
            }
        }
        ...
        function W(t) {
            t.blockchain instanceof j && t.purse instanceof T && t.autofund && t.blockchain.fund(t.purse.bsvAddress, 1e8)
        }
        ...
        function z(t, e, n, r, o) {
            ...
            if (void 0 === t) switch (r) {
                ...
                case "test":
                case "stn":
                    return i instanceof N && i.api === e && i.apiKey === n && i.network === r ? i : N.create({
                        api: e,
                        apiKey: n,
                        network: r,
                        cache: o,
                ...
                default:
                    if (G.defaults.blockchain instanceof a) return G.defaults.blockchain;
        ...
        function H(t) {
            ...
            if (void 0 === t) return G.instance && G.instance.cache ? G.instance.cache : "undefined" == typeof window ? new R : new $;
        ...
        function it(t) {
            return "*" === t || ("cache" === t || "string" == typeof t && (64 === t.length && /[a-fA-F0-9]+/.test(t)))
        }

        function st(t) {
            const e = d.te(t) || d.ee(),
                n = d.Gt(e);
            return G.instance ? n.Oe || n.xe(t) : n.Fe(t), e
        }
        ...
        G.instance = null, G.defaults = {}, G.defaults.api = void 0, G.defaults.apiKey = void 0, G.defaults.app = "", G.defaults.autofund = !0, G.defaults.blockchain = void 0, G.defaults.client = !1, G.defaults.inventory = void 0, G.defaults.logger = void 0, G.defaults.network = "main", G.defaults.networkRetries = 2, G.defaults.networkTimeout = 1e4, G.defaults.owner = void 0, G.defaults.preverify = !0, G.defaults.purse = void 0, G.defaults.rollbacks = !0, G.defaults.timeout = 3e4, G.defaults.trust = [], G.configure = (t, e) => {
            if (t.APP && (G.defaults.app = t.APP), e = e || t.NETWORK || G.defaults.network, G.defaults.network = e, "debug" === t.LOGGER) G.defaults.logger = console;
        ...
        P(G.module, "BrowserCache", (() => (ut("BrowserCache", ft), $))), P(G.module, "IndexedDbCache", (() => (ut("IndexedDbCache", ft), A))), P(G.module, "Inventory", (() => (ut("Inventory", ft), x))), P(G.module, "LocalCache", (() => (ut("LocalCache", ft), R))), P(G.module, "LocalOwner", (() => (ut("LocalOwner", ft), I))), P(G.module, "LocalPurse", (() => (ut("LocalPurse", ft), T))), P(G.module, "MatterCloud", (() => (ut("MatterCloud", ft), C))), P(G.module, "Mockchain", (() => (ut("Mockchain", ft), j))), P(G.module, "PayServer", (() => (ut("PayServer", ft), k))), P(G.module, "RemoteBlockchain", (() => (ut("RemoteBlockchain", ft), N))), P(G.module, "RunConnect", (() => (ut("RunConnect", ft), U))), P(G.module, "RunDB", (() => (ut("RunDB", ft), U))), P(G.module, "Viewer", (() => (ut("Viewer", ft), F))), P(G.module, "WhatsOnChain", (() => (ut("WhatsOnChain", ft), D))), G.extra = {}, P(G.extra, "asm", (() => n(39))), P(G.extra, "B", (() => n(55))), P(G.extra, "expect", (() => n(56))), P(G.extra, "Group", (() => n(38))), P(G.extra, "Hex", (() => n(26))), P(G.extra, "Token", (() => n(32))), P(G.extra, "Token10", (() => n(57))), P(G.extra, "Token20", (() => n(32))), P(G.extra, "Tx", (() => n(41))), P(G.extra, "txo", (() => n(40))), P(G, "asm", (() => (at("asm"), n(39)))), P(G, "B", (() => (at("B"), n(55)))), P(G, "expect", (() => (at("expect"), n(56)))), P(G, "Group", (() => (at("Group"), n(38)))), P(G, "Token", (() => (at("Token"), n(32)))), P(G, "Token10", (() => (at("Token10"), n(57)))), P(G, "Token20", (() => (at("Token10"), n(32)))), P(G, "Tx", (() => (at("Tx"), n(41)))), P(G, "txo", (() => (at("txo"), n(40)))), G.Sn = n(7).Sn, G.dn = n(11), G.Aa = n(15), G.xa = n(24), G.yn = n(13), G.Ia = n(46), G.Ra = n(47), G.pn = n(3).pn, G.uu = n(42), G.Ut = n(2), G.bn = n(19), G.Ft = n(0), G.Qr = n(14).Qr, G.Ca = n(22), G.Dt = n(10), G.j = n(0).j, G.gu = n(0).gu, G._u = n(0)._u, G.ja = n(20), G.mn = n(21), G.En = m, G.Ta = n(49), G.vs = n(15).vs, G.ka = n(29), G.g = n(7).g, G.mr = n(16), G.sha256 = b, G.api = {}, G.api.Blockchain = a, G.api.Logger = u, G.api.Purse = h, G.api.Cache = f, G.api.Lock = l, G.api.Owner = p, G.errors = n(4), G.util = {}, G.util.CommonLock = CommonLock, G.util.metadata = t => n(14).Qr(new r.Transaction(t)), G.util.install = st, G.util.unify = function(...t) {
            ...
            _(t, t)
        }, G.util.uninstall = ct, P(G, "CommonLock", (() => (ht("CommonLock"), CommonLock))), P(G, "install", (() => (ht("install"), st))), P(G, "uninstall", (() => (ht("uninstall"), ct))), P(G.prototype, "payload", (() => (console.warn("Run.prototype.payload deprecated. Use Run.util.metadata."), G.util.metadata))), P(G.prototype, "unify", (() => (console.warn("Run.prototype.unify deprecated. Use Run.util.unify."), G.util.unify))), G.prototype.payload = G.util.metadata, G.version = "0.6.15", G.protocol = n(16).Tr, t.exports = G
    }, function(t, e, n) {
        const r = n(9),
            {
                L: o,
        ...
        class u {
            ...
            bu(t, e) {
                if (!(this.yu.has("*") || this.yu.has(t) || "cache" === e && this.yu.has("cache"))) {
        ...
        (function(t) {
            ...
            a.prototype.slice = function(t, e) {
                ...
                return t = +t, e |= 0, n || j(this, t, e, 1, 255, 0), a.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), this[e] = 255 & t, e + 1
            }, a.prototype.writeUInt16LE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 2, 65535, 0), a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : k(this, t, e, !0), e + 2
            }, a.prototype.writeUInt16BE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 2, 65535, 0), a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : k(this, t, e, !1), e + 2
            }, a.prototype.writeUInt32LE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 4, 4294967295, 0), a.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : N(this, t, e, !0), e + 4
            }, a.prototype.writeUInt32BE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 4, 4294967295, 0), a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : N(this, t, e, !1), e + 4
                ...
                return t = +t, e |= 0, n || j(this, t, e, 1, 127, -128), a.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), t < 0 && (t = 255 + t + 1), this[e] = 255 & t, e + 1
            }, a.prototype.writeInt16LE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 2, 32767, -32768), a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : k(this, t, e, !0), e + 2
            }, a.prototype.writeInt16BE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 2, 32767, -32768), a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : k(this, t, e, !1), e + 2
            }, a.prototype.writeInt32LE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 4, 2147483647, -2147483648), a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : N(this, t, e, !0), e + 4
            }, a.prototype.writeInt32BE = function(t, e, n) {
                return t = +t, e |= 0, n || j(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : N(this, t, e, !1), e + 4
        ...
        t.exports = class {
            constructor(t = {}) {
                this.localCache = new r({
                    maxSizeMB: t.maxMemorySizeMB
                }), this.indexedDbCache = new o({
                    dbName: t.dbName,
                    dbStore: t.dbStore,
            ...
            async set(t, e) {
                return Promise.all([this.localCache.set(t, e), this.indexedDbCache.set(t, e)])
            }
            async get(t) {
                return await this.localCache.get(t) || await this.indexedDbCache.get(t)
            }
        }
    }, function(t, e, n) {
        const r = n(2),
            ...
            activate(t) {
                ...
                const e = async () => {
                    try {
                        ...
                        if (this.La !== e) return;
                        this.Ba = o(n), r.zt && r.Yt(a, "Owner", n), this.vi && this.vi.forEach((t => this.Fa(t))), this.vi = null
                    } catch (t) {
                        if (this.La !== e) return;
            ...
            async sign(t, e, o) {
                ...
                for (let t = 0; t < c.inputs.length; t++) {
                    ...
                    if (n || s) {
                        ...
                        const r = await h(c, t, n, e[t].satoshis, this.bsvPrivateKey),
                    ...
                    if (o[t] instanceof Group && o[t].pubkeys.includes(this.pubkey) && c.inputs[t].script.chunks.length <= o[t].required) {
                        const n = c.inputs[t].script.chunks.slice(1).map((t => t.buf.toString("hex"))),
                            ...
                            a = await p(c, t, s, n, o[t].pubkeys);
                        if (a.includes(this.pubkey)) continue;
                        const u = new i(e[t].script),
                            f = await h(c, t, u, e[t].satoshis, this.bsvPrivateKey),
                            l = o[t].pubkeys.map((t => {
                                const e = a.indexOf(t);
            ...
            async pay(t, e) {
                ...
                for (let t = b; t < o.inputs.length; t++) {
                    const e = o.inputs[t].output,
                        n = await h(o, t, e.script, e.satoshis, this.bsvPrivateKey),
        ...
        t.exports = class {
            constructor(t) {
                this.host = t, this.localCache = new r
            }
            async get(t) {
                ...
                let n;
                if (t.startsWith("tx://")) {
                    const e = t.slice("tx://".length);
                    n = `${this.host}/tx/${e}`
                } else if (t.startsWith("jig://")) {
                    const e = t.slice("jig://".length);
                    n = `${this.host}/jig/${e}`
                } else {
                    if (!t.startsWith("berry://")) return; {
                        const e = t.slice("berry://".length);
                        n = `${this.host}/location/${e}`
                    }
                }
                try {
                    const e = await o.Gt(n);
                    return t.startsWith("tx://") ? e.trim() : JSON.parse(e)
                } catch (t) {
